    ...
    switch (quest.kind) {
      ...
      case 12:
        ...
        return {
          ...
          completed: userQuest ? userQuest.complete : false,
          ...
          question_answered: userQuest ? userQuest.question_answered : false,
          songs_heard:
            userQuest && userQuest.tracks ? userQuest.tracks.split(';') : [],
